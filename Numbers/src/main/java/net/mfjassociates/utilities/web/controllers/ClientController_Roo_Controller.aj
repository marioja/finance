...
import net.mfjassociates.utilities.web.controllers.ClientController;
...
privileged aspect ClientController_Roo_Controller {
    ...
    void ClientController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("client_created_date_format", "yyyy-MM-dd HH:mm:ss");
        uiModel.addAttribute("client_updated_date_format", "yyyy-MM-dd HH:mm:ss");
    }
