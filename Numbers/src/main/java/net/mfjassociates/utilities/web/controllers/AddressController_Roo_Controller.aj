...
import net.mfjassociates.utilities.web.controllers.AddressController;
...
privileged aspect AddressController_Roo_Controller {
    ...
    void AddressController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("address_created_date_format", "yyyy-MM-dd HH:mm:ss");
        uiModel.addAttribute("address_updated_date_format", "yyyy-MM-dd HH:mm:ss");
    }
